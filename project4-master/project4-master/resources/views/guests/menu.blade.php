...
<div class="flex text-2xl font-bold py-2 px-4 flex-1 items-center flex justify-evenly">
  ...
  <div class="flex flex-row-reverse ml-2 w-full">
    <div slot="icon" class="relative">
        <svg onclick="window.location.href ='/betalen/{{$bestellingen->id}}';" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-cart w-6 h-6 mt-2">
